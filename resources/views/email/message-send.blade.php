...
text-align: center; text-decoration: none; -webkit-text-size-adjust: none;',
    ...
    Hi {{$data['name']}}, we’re glad you’re here! Following are your account details: <br></h2>
            ...
            <td style="{{ $style['email-wrapper'] }}" align="center"><table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}"><p style="{{ $style['paragraph-sub'] }}"> &copy; {{ date('Y') }} <a style="{{ $style['anchor'] }}" href="{{ url('clublia.com') }}" </a>.
                                            Todos los derechos reservados. Club LIA </p></td>
                                </tr>
                            </table></td>
                    </tr>
                </table></td>
